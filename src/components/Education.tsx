...
<article style={{    
    ...
    justifyContent: 'center'
        ...
        <article>
            <div style={{backgroundColor: 'white' , width: '70px', padding:'3px', borderRadius: '50%', display: 'flex'}}><img style={{width: '100%'}} src={codehslogo} alt="eduLogo"/></div>
            <ul style={{listStyle:'none'}}>
            <li>Georgian Tecnical Univerciti </li>
            <li> information tecnology </li>
            <li> compiuter enginering and network </li>
                    </ul>
        </article>
