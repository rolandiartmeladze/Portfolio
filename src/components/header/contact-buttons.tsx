  ...
  return (
    <div className="flex lg:gap-2">
      ...
      <Link
        ...
        className="flex p-2 border-l text-primary bg-muted rounded-e-md items-center gap-2 lg:px-4 lg:py-2  lg:bg-secondary lg:border-l-0 lg:shadow-lg hover:bg-background hover:border-b border-primary"
      >
