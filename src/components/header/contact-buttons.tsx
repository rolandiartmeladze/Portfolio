...
<div className="flex flex-row lg:gap-2">
      <Link
        ...
        className="flex px-2 border-r rounded-s-md text-primary bg-muted items-center gap-2 lg:px-4 lg:py-2 lg:bg-secondary lg:border-r-0 lg:shadow-lg hover:bg-background hover:border-b border-primary"
      >
