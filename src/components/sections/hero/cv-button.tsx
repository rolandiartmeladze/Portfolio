      ...
      >
        ...
        {isHovered && (
          <div className="absolute -top-10 -left-1/2 flex space-x-2">
            <Link
              href="https://drive.usercontent.google.com/uc?id=1HPm7b5h1Gw_n9_tOgMJYRrnT-fq1srvs&export=download"
              target="_blank"
            >
              <Icons.download className="size-10 p-1 rounded-t-md bg-muted hover:scale-110 transition-transform" />
            </Link>
            <Link
              href="https://drive.google.com/file/d/1HPm7b5h1Gw_n9_tOgMJYRrnT-fq1srvs/view"
              target="_blank"
            >
